...
set(YOTTA_CFG_UICR_SERIAL_END 0x10001088)

set(SREC_FLAGS "")

# uicr device type
set(SREC_FLAGS ${SREC_FLAGS} -generate ${UICR_DEVICE_TYPE_ADDRESS_START} ${UICR_DEVICE_TYPE_ADDRESS_END} -CONSTant_Little_Endian ${YOTTA_CFG_UICR_DEVICE_TYPE} 2)

# uice device version
set(SREC_FLAGS ${SREC_FLAGS} -generate ${UICR_DEVICE_VERSION_ADDRESS_START} ${UICR_DEVICE_VERSION_ADDRESS_END} -CONSTant_Little_Endian ${YOTTA_CFG_UICR_DEVICE_VERSION} 2)
